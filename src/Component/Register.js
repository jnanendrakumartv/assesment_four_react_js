...
class Register extends Component{
    ...
    handleSubmit=(event)=>{
        ...
        if(usernamel===0) this.setState({user:'Username must required'});
        ...
        return(
            <div className="main">
                ...
                <div className="col-sm-4 col-lg-4 col-md-4 col-xs-4">
                  ...
                  <p className='color'>{this.state.firstnameA}</p>
                  ...
                  <p className='color'>{this.state.lastnameA}</p>
                  ...
                  <p className='color'>{this.state.user}</p>
